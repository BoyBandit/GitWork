...
public class ProgressDownDisable<T extends DownloadData,V extends DownView>  extends BaseDisable<T,V>{
    //弱引用结果回调
//    private SoftReference<HttpDownloadListener> mSubscriberOnNextListener;
    ...
    public ProgressDownDisable(DownloadData<V> downInfo, Handler handler, DownLoadPresenter downLoadPresenter) {
    ...
    public void onError(Throwable e) {
        ...
        downLoadPresenter.remove(downInfo);
//        DownLoadPresenter.getInstance().remove(downInfo);
