...
import com.news.frame.inter.downDisable.ProgressDownDisable;
...
public class DownLoadPresenter extends MvpPresenter<DownView> {
    /*记录下载数据*/
    private Set<DownloadData> downInfos;
    /*回调Disable队列*/
    private HashMap<String, ProgressDownDisable> subMap;
    /*单利对象*/
    private volatile static DownLoadPresenter INSTANCE;
    /*数据库类*/
...
//    @Override
//    public void onAttachView(DownView view) {
...
//    }
    ...
    @Override
    public void attachView(DownView view) {
    ...
    public void startDown(final DownloadData info, String baseUrl) {
        ...
        /*添加回调处理类*/
        ProgressDownDisable disable = new ProgressDownDisable(info, handler, this);
        /*记录回调sub*/
    ...
    public void stopDown(DownloadData info) {
        ...
        if (subMap.containsKey(info.getUrl())) {
            ProgressDownDisable subscriber = subMap.get(info.getUrl());
            subscriber.dispose();
